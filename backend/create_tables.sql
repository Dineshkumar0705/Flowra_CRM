-- Flowra: create all tables directly
-- Run with: psql flowra_db -f create_tables.sql
-- Then: alembic stamp 001_initial_schema

-- ENUM TYPES
DO $$ BEGIN CREATE TYPE userrole AS ENUM ('super_admin','admin','manager','sales','viewer'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE workspaceplan AS ENUM ('starter','growth','agency'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE memberrole AS ENUM ('owner','admin','member'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE contactsource AS ENUM ('manual','import','whatsapp','gmail','web_form','referral'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE dealstage AS ENUM ('new','contacted','qualified','proposal','negotiation','won','lost'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE dealpriority AS ENUM ('low','medium','high'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE messagedirection AS ENUM ('inbound','outbound'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE messagetype AS ENUM ('text','image','document','audio','video','template','interactive'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE messagestatus AS ENUM ('queued','sent','delivered','read','failed'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE emaildirection AS ENUM ('inbound','outbound'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE subscriptionstatus AS ENUM ('created','authenticated','active','halted','cancelled','expired'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE paymentstatus AS ENUM ('pending','captured','failed','refunded'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE billingplan AS ENUM ('starter','growth','agency'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE notificationtype AS ENUM ('deal_won','new_lead','overdue_task','payment_failed','team_mention','whatsapp_received','email_received','autopilot_completed','system'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
